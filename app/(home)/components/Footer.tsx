    ...
    <footer className="w-full py-10">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 my-5 md:mt-10 text-center">
          Feel free to get in touch, and let's chat about how can I support you
      ...
      <div className="flex flex-col space-y-3 mt-16 md:flex-row justify-between items-center">
        <p className="text-sm font-light md:text-base md:font-normal">
          Copyright &copy; 2024 Natnael Demelash
        </p>
        <div className="flex items-center gap-6 md:gap-3">
          {socialMedia.map((social, index) => (
            <div key={index}>
              <Image src={social.img} alt="social" width={25} height={25} />
            </div>
          ))}
        </div>
      </div>
